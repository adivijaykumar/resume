...
\begin{itemize}[leftmargin=*]
    ...
    \item \textit{Probing host environments of gravitational-wave sources} at \textbf{Penn State University}, October 2024 (Invited talk)
    \item \textit{Host galaxies of compact binaries and their impact on dark siren cosmology} at \textbf{IUCAA}, August 2024
    \item \textit{Panelist: Data analysis challenges for next generation detectors} at \textbf{PAX Meeting, London}, July 2024 (Invited seminar)
    \item \textit{Probing host environments of gravitational-wave sources} at \textbf{Cardiff University}, July 2024 (Invited seminar)
    \item \textit{Probing host environments of gravitational-wave sources} at \textbf{CIERA, Northwestern University}, June 2024 (Invited seminar)
    \item \textit{Probing host galaxies of merging compact binaries} at \textbf{CASCA Meeting, Toronto}, June 2024 (Contributed talk)
    \item \textit{Compact binaries in clusters and how to find them} at \textbf{Globular Clusters and their Tidal Tails}, May 2024 (Contributed talk)    
    \item \textit{Probing host environments of gravitational-wave sources} at \textbf{GRAPPA, University of Amsterdam}, May 2024 (Invited seminar)
    \item \textit{Probing host environments of gravitational-wave sources} at \textbf{Niels Bohr Institute}, April 2024 (Invited seminar)
...
\begin{itemize}[leftmargin=*]
	\item Participant, \textbf{Gravitational waves: A new ear on the chemistry of galaxies}, Lorentz Center, Leiden, Netherlands. April 2024.
