...
\begin{center}
    \hspace{-\hoffset}
    \href{mailto:aditya@utoronto.ca}{aditya.vijaykumar@utoronto.ca} ~\textbullet~ \href{http://adivijaykumar.github.io}{Website} ~\textbullet~ \ Canadian Institute for Theoretical Astrophysics (CITA)
\end{center}
\vspace{-7mm}
\begin{resume}
